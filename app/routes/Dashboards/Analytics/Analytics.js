                ...
                <Grid>
                    ...
                    >
                        <Grid.Col { ...(applyColumn('metric-v-target-users', layouts)) } >
                            <Card>
                                <CardHeader className="bb-0 pt-3 pb-0 bg-none" tag="h6">
                                    <i className="fa fa-ellipsis-v text-body mr-2"></i> Active Cases
                                </CardHeader>
                                <CardBody className="pt-2">
                                    <MetricVsTarget 
                                        title="Users"
                                        value={this.state.covid19.active}
										 progressbarValue={this.state.activeProgress}
                                        progressbarColor="primary"
                                        targetValue={this.state.covid19.total}
										date={new Date()}
                                    />
                                </CardBody>
                               {/* <CardFooter>
                        ...
                        <Grid.Col { ...(applyColumn('metric-v-target-sessions', layouts)) }>
                            <Card>
                                <CardHeader className="bb-0 pt-3 pb-0 bg-none" tag="h6">
                                    <i className="fa fa-ellipsis-v text-body mr-2"></i> Total Recovered
                                </CardHeader>
                                <CardBody className="pt-2">
                                    <MetricVsTarget 
                                        title="Total Recovered"
                                        value={this.state.covid19.recovered}
                                        progressbarValue={this.state.recoveredProgress}
                        ...
                        <Grid.Col { ...(applyColumn('metric-v-target-pageviews', layouts)) }>
                            <Card>
                                <CardHeader className="bb-0 pt-3 pb-0 bg-none" tag="h6">
                                    <i className="fa fa-ellipsis-v text-body mr-2"></i> Total Deaths
                                </CardHeader>
                                <CardBody className="pt-2">
                                    <MetricVsTarget 
                                        title="Total Deaths"
                                        value={this.state.covid19.deaths}
                                        progressbarValue={this.state.deaths}
